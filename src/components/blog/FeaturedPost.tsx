        ...
        <div className="bg-[#FFFFFF] rounded-2xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.08)] hover:shadow-[0_12px_40px_rgba(0,0,0,0.14)] transition-all duration-300 border border-[#E0D8D2]/50">
          <div className="grid lg:grid-cols-2">
            ...
            <div className="aspect-[16/10] lg:aspect-auto lg:min-h-[280px] relative overflow-hidden">
              ...
              {category && (
                <span
                  ...
                  style={{ backgroundColor: category.color ? `${category.color}cc` : 'rgba(75, 45, 127,0.8)' }}
                >
                  {category.title}
                </span>
              )}
            ...
            <div className="p-6 lg:p-8 flex flex-col justify-center">
              ...
              <h2 className="text-xl lg:text-2xl font-bold text-[#4B2D7F] mb-3 group-hover:text-[#4B2D7F] transition-colors line-clamp-2">
                {post.title}
              </h2>
                  ...
                  <div className="flex items-center gap-2">
                    {post.author.image ? (
                      ...
                      <div className="w-8 h-8 rounded-full bg-[#F4F0EA] flex items-center justify-center ring-1 ring-[#E0D8D2]/50">
                        <span className="text-xs font-bold text-[#4B2D7F]">
              ...
              <div className="flex items-center gap-2 text-[#4B2D7F] font-semibold text-[13px] group-hover:gap-3 transition-all">
                Read Article
