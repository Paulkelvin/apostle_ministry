      ...
      {featuredPost && !search && !activeCategory && (
          <section className="relative w-full h-[70vh] min-h-[480px] max-h-[640px] overflow-hidden">
            ...
            {featuredPost.mainImage ? (
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#2E1F47] to-[#4B2D7F]" />
            )}
      ...
      <section className={`pb-4 ${(!featuredPost || search || activeCategory) ? 'pt-32' : 'pt-10'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-6">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-[#4B2D7F] tracking-tight">Resources</h2>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mt-5">
            ...
            <div className="relative flex-shrink-0" ref={sortRef}>
              <button
                ...
                className="flex items-center gap-2 text-sm text-[#332D2D] bg-[#FFFFFF] border border-[#E0D8D2] rounded-lg px-4 py-2 hover:border-[#4B2D7F] transition-colors"
              >
                    ...
                    {(['newest', 'oldest'] as SortOption[]).map((opt) => (
                      <button
                        ...
                        className={`block w-full text-left px-4 py-2 text-sm hover:bg-[#F4F0EA] transition-colors ${
                          sortBy === opt ? 'text-[#4B2D7F] font-medium bg-[#F4F0EA]/50' : 'text-[#332D2D]'
                        }`}
                      >
              ...
              <AnimatePresence mode="wait">
                {paginatedPosts.length > 0 ? (
                    ...
                    {totalPages > 1 && (
                      <div className="mt-10 flex items-center justify-center gap-2">
                        <button
                          ...
                          className="w-9 h-9 rounded-lg border border-[#E0D8D2] flex items-center justify-center text-[#332D2D] hover:border-[#4B2D7F] hover:text-[#4B2D7F] disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                        >
                          ...
                          <button
                            ...
                            className={`w-9 h-9 rounded-lg text-sm font-medium transition-colors ${
                              currentPage === page
                                ...
                                : 'border border-[#E0D8D2] text-[#332D2D] hover:border-[#4B2D7F] hover:text-[#4B2D7F]'
                            }`}
                          >
                            {page}
                          </button>
                  ...
                  >
                    ...
                    <h2 className="text-xl font-bold text-[#4B2D7F] mb-2">
