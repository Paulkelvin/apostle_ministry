          ...
          <div className="flex items-center justify-between h-[72px] min-h-[72px]">
            ...
            <Link href="/" className="flex items-center space-x-2 group">
              <span
                className={`text-2xl font-bold tracking-tight transition-colors duration-300 ${
                  showSolid ? 'text-[#4B2D7F]' : 'text-white'
                }`}
                ...
                return (
                  <Link
                    ...
                    className={`relative px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${
                      showSolid
                        ? isActive
                          ? 'text-[#4B2D7F] bg-[#F4F0EA]'
                          : 'text-[#332D2D] hover:text-[#4B2D7F] hover:bg-[#F4F0EA]'
                        : isActive
            ...
            <button
              className={`md:hidden p-2 rounded-lg transition-colors ${
                showSolid ? 'text-[#4B2D7F] hover:bg-[#F4F0EA]' : 'text-white hover:bg-white/10'
              }`}
            ...
            >
              <div className="p-6">
                <div className="flex justify-between items-center mb-10">
                  <span className="text-xl font-bold text-[#4B2D7F]">
                    Menu
                  </span>
                  <button
                    onClick={() => setIsMobileMenuOpen(false)}
