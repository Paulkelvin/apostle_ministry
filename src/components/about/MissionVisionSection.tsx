...
export function MissionVisionSection({ mission, vision }: MissionVisionSectionProps) {
  ...
  const coreValues = [
    ...
    { title: 'Growth', description: "We're committed to becoming more like Jesus every day.", icon: TrendingUp, color: '#5B2D91' },
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="absolute top-[25%] left-[-10%] select-none pointer-events-none opacity-[0.02] transform -rotate-6 z-0 mix-blend-multiply">
        <h1 className="text-[12rem] md:text-[20rem] font-bold whitespace-nowrap" style={{ fontFamily: 'Georgia, serif', color: '#5B2D91' }}>
          ACTS 2:42
        </h1>
      </div>
      ...
      <section className="relative overflow-hidden z-10">
        <div className="grid lg:grid-cols-2 min-h-[600px]">
          ...
          <div className="relative bg-[#5B2D91] py-20 px-6 sm:px-10 lg:px-16 flex items-center">
          ...
          <div className="relative bg-[#FCFBF9] py-20 px-6 sm:px-10 lg:px-16 flex items-center">
            ...
            <div className="absolute bottom-10 left-10 grid grid-cols-4 gap-2 opacity-10">
              {[...Array(16)].map((_, i) => (
                <div key={i} className="w-2 h-2 rounded-full bg-[#5B2D91]" />
              ))}
            </div>
            ...
            <motion.div
              ...
              className="relative z-10 max-w-lg"
            >
              <span className="inline-flex items-center gap-2 text-[#5B2D91] text-xs font-bold tracking-[0.2em] uppercase mb-6">
                <span className="w-8 h-px bg-[#5B2D91]" />
                Where We&apos;re Going
              </span>
              <h2 className="text-4xl md:text-5xl font-bold text-[#5B2D91] mb-6 leading-tight">
                Our Vision
              </h2>
              ...
              <div className="mt-8 pl-6 border-l-4 border-[#D4AF37]">
                <p className="text-[#5B2D91] italic text-base">
      ...
      <section className="py-24 bg-gradient-to-b from-[#F4F0EA] to-[#FCFBF9] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="inline-flex items-center justify-center gap-3 text-[#5B2D91] text-xs font-bold tracking-[0.2em] uppercase mb-4">
              <span className="w-12 h-px bg-[#D4AF37]" />
              What Guides Us
              <span className="w-12 h-px bg-[#D4AF37]" />
            </span>
            <h2 className="text-4xl md:text-5xl font-bold text-[#5B2D91]">Our Core Values</h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
            {coreValues.map((value, index) => {
              ...
              return (
                ...
                >
                  <div className="relative bg-white rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-[0_20px_50px_rgba(91, 45, 145,0.15)]">
                    {/* Top accent bar */}
                    <div 
                    ...
                    <div className="p-8 lg:p-10">
                      ...
                      <div className="mb-4">
                        <h3 
                          className="text-2xl lg:text-[1.75rem] font-bold text-[#5B2D91] mb-2"
