      ...
      <div className="bg-white rounded-xl p-4 shadow-sm border border-[#F4F0EA]">
        <div className="flex items-center gap-2 mb-3">
          ...
          {showingDirections && (
            <button
              onClick={handleReset}
              className="ml-auto text-xs flex items-center gap-1 text-[#8A8080] hover:text-[#6B4F9E] transition-colors"
            >
      ...
      <div className="rounded-2xl overflow-hidden shadow-lg h-[380px] ring-1 ring-[#E0D8D2]/60 relative">
        ...
        {isLoading && (
          <div className="absolute inset-0 bg-white/90 backdrop-blur-sm z-10 flex flex-col items-center justify-center">
            ...
            <p className="text-sm font-medium text-[#6B4F9E]">Fetching directions...</p>
