...
const components: PortableTextComponents = {
  ...
  block: {
    ...
    h2: ({ children }) => (
      <h2 className="font-display text-3xl font-semibold text-warm-900 mt-12 mb-6">{children}</h2>
    ),
    h3: ({ children }) => (
      <h3 className="font-display text-2xl font-semibold text-warm-900 mt-10 mb-4">{children}</h3>
    ),
    h4: ({ children }) => (
      <h4 className="font-display text-xl font-semibold text-warm-900 mt-8 mb-4">{children}</h4>
    ),
    blockquote: ({ children }) => (
      <blockquote className="border-l-2 border-accent pl-6 py-2 my-8 italic text-warm-600">
        {children}
      </blockquote>
    ),
  },
