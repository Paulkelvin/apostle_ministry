              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="relative aspect-video lg:aspect-auto lg:min-h-[400px]">
                  {featuredSermon.videoUrl ? (
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-[#5B2D91] to-[#321D52] flex items-center justify-center">
                ...
                <div className="p-8 lg:px-12 lg:py-10 flex flex-col justify-center bg-gradient-to-br from-[#1F1F1F] to-[#1A1A1A]">
                  ...
                  {featuredSermon.series && (
                    <span className="inline-block text-xs font-semibold px-4 py-1.5 rounded-full bg-[#5B2D91]/30 text-[#E0D8D2] border border-[#CBA052]/10 mb-6 w-fit">
                      {featuredSermon.series}
                    </span>
                  )}
                  {featuredSermon.videoUrl && (
                    <button
                      onClick={() => handlePlayVideo(featuredSermon.videoUrl!, featuredSermon.title)}
                      className="inline-flex items-center gap-2 px-6 py-3 bg-[#CBA052] text-[#4A2878] font-bold rounded-lg hover:bg-[#B8933F] transition-colors w-fit"
                    >
                      <Play className="w-4 h-4" fill="#4A2878" />
                      Watch Now
                    </button>
                  )}
                </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-[#F4F0EA] border border-[#E0D8D2] rounded-lg text-sm text-[#332D2D] placeholder:text-[#8A8080] focus:outline-none focus:border-[#5B2D91] transition-colors"
                />
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 pl-4 pr-3 py-2.5 bg-[#F4F0EA] border border-[#E0D8D2] rounded-xl text-sm font-medium text-[#332D2D] cursor-pointer hover:border-[#5B2D91]/30 focus:outline-none focus:border-[#5B2D91] transition-all duration-200"
                  >
                  ...
                  <div className={`absolute right-0 top-full mt-2 w-44 bg-white rounded-xl shadow-xl shadow-[#5B2D91]/10 border border-[#E0D8D2]/50 overflow-hidden z-50 transition-all duration-200 origin-top ${
                    showSortDropdown 
                    ...
                    <div className="py-1">
                      <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 text-sm transition-colors duration-150 ${
                          sortBy === 'newest' 
                            ? 'bg-[#5B2D91]/5 text-[#5B2D91] font-semibold' 
              ...
              <div className="flex flex-wrap items-start gap-4 pt-4 border-t border-[#E0D8D2]">
                ...
                {hasActiveFilters && (
                  <button
                    ...
                    className="inline-flex items-center gap-1 text-sm text-[#5B2D91] hover:text-[#321D52] font-medium ml-auto transition-colors duration-200"
                  >
                    <X className="w-4 h-4" />
                    Clear all
                  </button>
        ...
        <section className="py-20 bg-[#FCFBF9] relative overflow-hidden">
          ...
          {filteredSermons.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <h2 className="text-2xl font-bold text-[#5B2D91] mb-2">
              ...
              {hasActiveFilters && (
                <button
                  onClick={clearFilters}
                  className="mt-4 text-[#5B2D91] font-semibold hover:underline"
                >
                  Clear filters
                </button>
              )}
