...
export function LatestNewsSection({ posts, accentImage }: LatestNewsSectionProps) {
    ...
    return (
      <section className="py-16 bg-[#F4F0EA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-3" style={{ color: '#4B2D7F' }}>Latest Resources</h2>
  ...
  return (
    <section className="relative py-20 lg:py-28 bg-[#F4F0EA] overflow-hidden">
      ...
      <FloatingCross className="bottom-[10%] right-[3%] opacity-15 mix-blend-multiply z-0" delay={1.5} size={60} color="#4B2D7F" />
        ...
        <div className="relative mb-12 lg:mb-16 overflow-hidden">
          ...
          <div className="relative flex flex-col sm:flex-row justify-between items-start sm:items-end">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-1" style={{ color: '#4B2D7F' }}>Latest Resources</h2>
              <p className="text-sm" style={{ color: '#5C5252' }}>Stories, devotionals, and news from our community</p>
            </div>
            <Link
              href="/resources"
              className="mt-4 sm:mt-0 inline-flex items-center gap-2 font-semibold text-sm hover:text-[#2E1F47] transition-colors"
              style={{ color: '#4B2D7F' }}
            >
              View All Resources
          ...
          <Link href={`/resources/${featured.slug?.current}`} className="group block">
            <article className="relative h-full min-h-[420px] lg:min-h-[520px] rounded-2xl overflow-hidden bg-[#332D2D]">
              {featured.mainImage ? (
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#4B2D7F]/30 to-[#D4AF37]/10 flex items-center justify-center">
                  ...
                  <article className="flex flex-col sm:flex-row gap-5 h-full bg-white rounded-2xl overflow-hidden border border-[#E0D8D2]/50 shadow-[0_8px_24px_rgba(0,0,0,0.04)] hover:shadow-[0_12px_32px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-300 p-4 sm:p-5">
                    ...
                    <div className="relative w-full sm:w-40 md:w-48 flex-shrink-0 aspect-[4/3] sm:aspect-square rounded-xl overflow-hidden">
                      {post.mainImage ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-[#4B2D7F]/10 to-[#D4AF37]/10 flex items-center justify-center">
                    ...
                    <div className="flex flex-col justify-center flex-1 min-w-0">
                      ...
                      <h3 className="text-base md:text-lg font-bold mb-1.5 leading-snug line-clamp-2 group-hover:text-[#5C3A93] transition-colors" style={{ color: '#4B2D7F' }}>
                        {post.title}
                      </h3>
                      {post.excerpt && (
              ...
              <Link href="/resources" className="flex-1 block">
                <div className="flex items-center justify-center h-full min-h-[200px] rounded-2xl border-2 border-dashed border-[#E0D8D2] hover:border-[#D4AF37] transition-colors duration-300">
                  <div className="text-center">
                    <p className="font-semibold mb-1" style={{ color: '#4B2D7F' }}>Explore More</p>
