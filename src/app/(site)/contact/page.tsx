...
export default async function ContactPage() {
  ...
  return (
    <>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-[#E6D8C8] via-[#F0E6D8] to-[#FDFBF7] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="pt-4 lg:pt-8">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-[#292121] mb-6 tracking-tight leading-[1.1]">
                Contact Us
              </h1>
              <p className="text-lg text-[#665A58] mb-10 max-w-md leading-relaxed">
              ...
              <div className="space-y-4 mb-10">
                <a
                  ...
                  className="flex items-center gap-4 p-3 -ml-3 rounded-xl text-[#665A58] hover:bg-white/60 hover:text-primary transition-all group"
                >
                  ...
                  <div>
                    <span className="text-xs text-[#968B89] block">Email</span>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-gradient-to-br from-[#fdf2f2] to-white border border-primary/[0.08] hover:border-primary/20 hover:shadow-md transition-all group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-[#292121]">Pastoral Support</h3>
              </div>
              <p className="text-[#665A58] text-sm leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-[#fdf8f0] to-white border border-accent/[0.1] hover:border-accent/20 hover:shadow-md transition-all group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-[#292121]">Feedback &amp; Suggestions</h3>
              </div>
              <p className="text-[#665A58] text-sm leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-[#f0f5f1] to-white border border-sage/[0.1] hover:border-sage/20 hover:shadow-md transition-all group">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-[#292121]">Media Inquiries</h3>
              </div>
              <p className="text-[#665A58] text-sm leading-relaxed">
      ...
      <section className="py-20 bg-gradient-to-b from-[#F0E6D8] via-[#E6D8C8] to-[#DCCFC0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block text-xs font-bold tracking-[0.2em] uppercase text-primary mb-3">Visit Us</span>
              <h2 className="text-3xl md:text-4xl font-bold text-[#292121] leading-tight">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-stretch">
            {/* Map Embed */}
            <div className="rounded-2xl overflow-hidden shadow-lg h-[420px] ring-1 ring-[#DCCFC0]/60">
              <iframe
                src={
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#E6D8C8] flex flex-col justify-center">
              <div className="space-y-6">
                <div>
                  <h3 className="font-bold text-[#292121] text-xl mb-3">
                    {serviceTimes?.locationName || 'Main Campus'}
                  </h3>
                  <p className="text-[#665A58] whitespace-pre-line leading-relaxed">
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3 text-[#665A58]">
                    <Phone className="w-4 h-4 text-[#968B89]" />
                    <a
                  ...
                  <div className="flex items-center gap-3 text-[#665A58]">
                    <Mail className="w-4 h-4 text-[#968B89]" />
                    <a
                      href={`mailto:${serviceTimes?.email || 'admin@rflcc.org'}`}
                      className="hover:text-primary transition-colors"
                    >
